			...
			<div
				...
				<div style={{display: 'flex', flexDirection: 'row'}}>
					...
					<button
						...
						Click to change focus state of editable externally
					</button>
				</div>
				<p />
				<p>
				...
				<p>
					Save button won`t be enabled until the user change the content. Also,
					the <b>'Enter'</b>
					won`t trigger, too.
				</p>
				<p>
					You can use the <b>seamless</b> styling of the component as
					illustrated below.
				</p>
				<p>
					For the sake illustration, model names limited to accept{' '}
					<b>only letters</b>. Also, year can accept <b>only numbers</b> as an
					input. Other inputs will generate an error message below the input
					field.
				</p>
				...
				<p>
					All of those are extremely customizable though the exposed props.
					Check the{' '}
					<a href='https://github.com/CeamKrier/react-editable-title#api'>
						docs
					</a>{' '}
					for it!
				</p>
